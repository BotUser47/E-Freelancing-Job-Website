...
<div class="text-center" style="padding:4%;background:#222;color:#fff;margin-top:20px;">
	<div class="row">
		...
		<div class="col-lg-3">
			<h3>About Us</h3>
			<p>Parnajit Majumder, JIS ID-1304054</p>
			<p>Saptaneel Chakraborty, JIS ID-1304041</p>
			<p>Mirnmoy Kundu, JIS ID-1304049</p>
			<p>&copy 2024</p>
		</div>
		<div class="col-lg-3">
			<h3>Contact Us</h3>
			<p>JIS college  Engineering and Technology</p>
